...
import { FiBox, FiHash, FiMapPin, FiTruck } from "react-icons/fi"; // Cambié a Feather Icons para consistencia
    ...
    <div className="p-8 space-y-8 animate-in fade-in duration-500">
      <header>
        <h1 className="text-2xl font-bold text-white flex items-center gap-3">
          <FiBox className="text-emerald-500" /> Gestión de Inventario
        </h1>
        <p className="text-slate-400 text-sm">Administra los equipos y activos disponibles para alquiler.</p>
      </header>
